...
2. Mendokumentasikan proses *triage* malware menggunakan sampel dari MalwareBazaar.
3. Membangun kebiasaan analisis keamanan yang sistematis dan terukur.

## Struktur Repositori
- `/journal`: Berisi entri catatan belajar mingguan.
